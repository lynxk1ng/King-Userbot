...
async def redis(alive):
    user = await bot.get_me()
    await get_readable_time((time.time() - StartTime))
    await alive.edit("Orang Ganteng")
    await alive.edit("Orang Tampan")
    await alive.edit("Orang Ganteng Main ML")
    await alive.edit("Marga Bang Otat")
    await alive.edit("P.A.W")
    await alive.edit("P.A.K")
    await alive.edit("P.A.R.P")
    await alive.edit("P.A.A.L")
    await alive.edit("__lynxking Tampan__")
    ...
    await alive.edit("👑𝗞𝗶𝗻𝗴-𝙐𝙎𝙀𝙍𝘽𝙊𝙏⚡")
    await alive.edit("Orang Paling Tampan didunia")
    await alive.edit("Marga K T Marga bang otat")
    await alive.edit("Ganteng Lagi😎")
    await alive.edit("Main ML😎")
    await alive.edit("Idaman Wanita😎")
    await alive.edit("Sabar Tod Bentar lagi")
    await alive.edit("Bentar lagi tod")
    await alive.edit("⚡")
