...
async def _(event):
    ...
    asyncio.sleep(3.5)
    await event.edit(f"**YAHAHA KE GBAN AMA {DEFAULTUSER} YA JANGAN NANGIS**")
    asyncio.sleep(5)
    await event.delete()
...
async def _(event):
    ...
    await event.delete()
    await event.reply("**MENGUNBAN...**")
    asyncio.sleep(3.5)
    await event.edit(f"**GUA UNGBAN KARENA {DEFAULTUSER} ITU BAIK**")
    asyncio.sleep(5)
    await event.delete()
